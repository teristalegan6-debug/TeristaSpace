...
import com.terista.space.core.app.LauncherActivity;
import com.terista.space.core.app.configuration.AppLifecycleCallback;
import com.terista.space.core.app.configuration.ClientConfiguration;
import com.terista.space.core.core.GmsCore;
import com.terista.space.core.core.NativeCore;
import com.terista.space.core.core.env.BEnvironment;
import com.terista.space.core.core.system.DaemonService;
...
import com.terista.space.core.entity.pm.InstallResult;

import com.terista.space.core.fake.delegate.ContentProviderDelegate;
import com.terista.space.core.fake.frameworks.BActivityManager;
import com.terista.space.core.fake.frameworks.BJobManager;
import com.terista.space.core.fake.frameworks.BPackageManager;
import com.terista.space.core.fake.frameworks.BStorageManager;
import com.terista.space.core.fake.frameworks.BUserManager;

import com.terista.space.core.fake.hook.HookManager;
import com.terista.space.core.proxy.ProxyManifest;
import com.terista.space.core.utils.FileUtils;
import com.terista.space.core.utils.ShellUtils;
import com.terista.space.core.utils.Slog;
import com.terista.space.core.utils.SimpleCrashFix;
import com.terista.space.core.utils.compat.BuildCompat;
import com.terista.space.core.utils.compat.BundleCompat;

import com.terista.space.core.utils.provider.ProviderCall;
import com.terista.space.core.utils.StackTraceFilter;
import com.terista.space.core.utils.SocialMediaAppCrashPrevention;
import com.terista.space.core.utils.DexCrashPrevention;
import com.terista.space.core.utils.NativeCrashPrevention;
import com.terista.space.core.utils.CrashMonitor;
import com.terista.space.core.utils.StoragePermissionHelper;
import com.terista.space.core.utils.LogSender;
...
public class BlackBoxCore extends ClientConfiguration {
    ...
    public void closeCodeInit(){
        try {
            Class entry = Class.forName("com.terista.space.core.closecode.Entry");
    ...
    public static com.terista.space.core.entity.AppConfig getAppConfig() {
        try {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Intent vpnIntent = new Intent(getContext(), com.terista.space.core.proxy.ProxyVpnService.class);
    ...
    public static boolean isRunningApplication(String packageName, int userId) {
        ...
        try {
            ...
            ServiceManager.get();
            com.terista.space.core.core.system.am.ActivityStack stack =
                (com.terista.space.core.core.system.am.ActivityStack) ServiceManager.getService(ServiceManager.ACTIVITY_MANAGER);
            if (stack == null) return false;
            java.util.Map<Integer, com.terista.space.core.core.system.am.TaskRecord> tasks =
                    com.terista.space.core.utils.Reflector.with(stack).field("mTasks").get();
            if (tasks == null) return false;
            for (com.terista.space.core.core.system.am.TaskRecord task : tasks.values()) {
                if (task.userId == userId && task.taskAffinity != null && task.taskAffinity.contains(packageName)) {
                    
                    for (com.terista.space.core.core.system.am.ActivityRecord activity : task.activities) {
