...
import com.terista.space.core.core.system.pm.IBPackageManagerService;
import com.terista.space.core.entity.pm.InstallOption;
import com.terista.space.core.entity.pm.InstallResult;
import com.terista.space.core.entity.pm.InstalledPackage;
import com.terista.space.core.utils.TransactionThrottler;
    ...
    private boolean isInstalledFallback(String packageName) {
        try {
            ...
            if (packageName != null && (packageName.equals("com.media.bestrecorder.audiorecorder") || 
                                       packageName.startsWith("com.terista.space.core"))) {
