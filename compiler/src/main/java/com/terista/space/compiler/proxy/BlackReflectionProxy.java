...
import com.terista.space.reflection.BlackReflectionInfo;
import com.terista.space.reflection.utils.ClassUtils;


public class BlackReflectionProxy {

    private static final ClassName BR = ClassName.get("com.terista.space.reflection", "BlackReflection");
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return com.terista.space.reflection.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
